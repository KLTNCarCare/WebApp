...
const DeletePriceCatalog = ({ _id, refetch }: DeletePriceCatalogProps) => {
  ...
  return (
    <>
      ...
      >
        <DialogTitle variant="h4">{t('priceCatalog.deleteTitle')}</DialogTitle>
        <DialogContent>
        ...
        <DialogTitle sx={{ p: 2 }}>
          <Stack>
            ...
            <Typography variant="h4">
              {t('priceCatalog.deleteSuccessTitle')}
            </Typography>
          </Stack>
        </DialogTitle>
        <DialogContent sx={{ px: 2 }}>
          <DialogContentText>
            {t('priceCatalog.deleteSuccess')}
          </DialogContentText>
        </DialogContent>
...
export default DeletePriceCatalog;
